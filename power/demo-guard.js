(() => {
    ...
    function maskByKey(key, value) {
        ...
        if (normalizedKey === "_window" || normalizedKey === "window" || normalizedKey === "window_name") return value;
        if (normalizedKey === "pon" || normalizedKey === "pon_number") return maskPon(value);
        ...
        if (normalizedKey.includes("phone") || normalizedKey.includes("mobile") || normalizedKey.includes("called")) {
